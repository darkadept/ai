...
//--------------------------- Init ---------------------------------------
//
//  This method needs to be called before you can use an instance of this
//  class. It calculates and sets up all the cells in the defined region.
//------------------------------------------------------------------------
...
//--------------------- Update -------------------------------------------
//
//  when called with an X/Y position this method increases the frequency
//  count of the cell at that position.
//------------------------------------------------------------------------
...
//------------------------ TicksLingered ---------------------------------
//
//  returns the frequency count of the cell at this location
//------------------------------------------------------------------------
...
//----------------------------- NumCellsVisited --------------------------
//
//  returns the total number of cells in the map which have been visited
//------------------------------------------------------------------------
