				          ...
				          m_PerfCountFreq(0)
{
	...
	if(QueryPerformanceFrequency( (LARGE_INTEGER*) &m_PerfCountFreq))
  {
  ...
  {
    //hardware does not support QueryPerformanceFrequency
    MessageBox(NULL,"New Computer needed!", "Timer problem", NULL);
  }
}
